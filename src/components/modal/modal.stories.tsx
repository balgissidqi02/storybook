...
const meta: Meta<typeof Modal> = {
  ...
  argTypes: {
    type: {
      ...
      description:
        'Defines the style of the modal. "Rounded" has rounded corners, while "Simple" has straight edges.',
      table: {
    ...
    size: {
      ...
      description:
        'Defines the size of the modal. "Small" is compact, "Medium" is standard, and "Large" is expansive.',
      table: {
...
export const Default: StoryObj<ModalProps> = {
  ...Template,
  args: {
    content: "This is a medium rounded modal.",
    type: "Rounded",
    size: "Medium",
  },
};
...
export const RoundedLarge: StoryObj<ModalProps> = {
  ...Template,
  args: {
    content: "This is a large rounded modal.",
    type: "Rounded",
    size: "Large",
  },
};
